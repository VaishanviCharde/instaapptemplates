                                                ...
                                                <div class="contact-form">
                                                    ...
                                                    <form id="signup-form" name="signup-form" method="post" autocomplete="off">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 mb-20">
                                                                <div class="form-group">
                                                                    <input class="form-control" type="password" name="sign_password" id="sign_password" placeholder="Password *">
                                                                </div>
                                                            </div>
                                                            <div class="col-12 mb-20">
                                                                <div class="form-group">
...
<!-- Body main wrapper end -->
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="predefined_styles">
                            <div class="skin-theme-switcher">
                                <h4>Color</h4>
                                <input type="color" value="<?php if(TEMPCOLOR !== NULL && TEMPCOLOR != "") { echo TEMPCOLOR; } else { echo '#541406'; } ?>" id="colorPicker" data-switchcolor="color1" class="styleswitch">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <input type="hidden" value="<?php if(TEMPCOLOR !== NULL && TEMPCOLOR != "") { echo TEMPCOLOR; } else { echo '#A0270C'; } ?>" id="colorPicker" data-switchcolor="color1" class="styleswitch">
    <!-- End Switcher -->
